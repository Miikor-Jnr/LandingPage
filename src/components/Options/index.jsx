...
<div className="grid grid-cols-2 gap-x-[74px]" >
            <div className="rounded-[85px] grid place-items-center oveflow-hidden relative" style={{transform:'rotate(360deg)'}}>
                <div className={inView ? "animate__animated animate__backInLeft animate__slow relative bg-[#000709] rounded-[85px]": 'relative bg-[#000709] rounded-[85px]'} ref={targetRef}>
